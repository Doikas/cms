...
<form action="" method='post'>
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            $query .= " FROM posts ";
            $query .= " LEFT JOIN categories ON posts.post_category_id = categories.cat_id WHERE post_user ='$user' ORDER BY posts.post_date Desc"; //remove where post_user=$user to see all posts
            ...
            while ($row = mysqli_fetch_assoc($select_posts)) {
                ...
                $count_commments = mysqli_num_rows($send_comment_query);
                echo "<td><a href='post_comments.php?id={$post_id}'>{$count_commments}</a></td>";
